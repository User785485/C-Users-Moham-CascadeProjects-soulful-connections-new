      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="w-full px-4 sm:px-8 pt-12 max-w-7xl mx-auto">
          ...
          <section className="bg-white p-12 rounded-3xl mb-16">
            ...
            >
              Les experts nous recommendent
            </motion.h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                {
                  text: "« My Muqabala révolutionne les rencontres en respectant nos valeurs, offrant un cadre sécurisé et personnalisé pour construire des relations durables. »",
                  author: "Mohamed B - Thérapeute de couple",
                },
                {
                  text: "« L’approche d’accompagnement pas à pas de My Muqabala est une avancée majeure dans le domaine des rencontres sérieuses pour la communauté musulmane. »",
                  author: "Fatima C - Love Coach",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
